"""
Django settings for ISStrah project.
...
SECRET_KEY = 'django-insecure-4ihdda3)j55zb(mtz=j3etwe*9er!j9^_c#us5)p@f5*l7k@(q'
...
WSGI_APPLICATION = 'ISStrah.wsgi.application'

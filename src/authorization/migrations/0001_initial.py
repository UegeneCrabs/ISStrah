    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('agent', 'Страховой агент'), ('users', 'Страховщик'), ('appraiser', 'Оценщик')], max_length=10, null=True, verbose_name='Тип пользователя')),
                ('experience', models.CharField(blank=True, max_length=100, null=True, verbose_name='Опыт')),

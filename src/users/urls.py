...
app_name = 'users'
urlpatterns = [
    path('cleint/', views.personal_account_client, name='personal_account_client'),
    path('agent', views.personal_account_agent, name='personal_account_agent'),
    path('appraiser', views.personal_account_appraiser, name='personal_account_appraiser'),
